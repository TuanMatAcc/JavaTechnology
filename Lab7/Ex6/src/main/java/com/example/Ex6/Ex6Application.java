...
import com.example.Ex6.Controller.StudentPagingImpl;
import com.example.Ex6.Controller.StudentPagingRepository;
import com.example.Ex6.Controller.StudentService;
import com.example.Ex6.Controller.StudentServiceImpl;
...
public class Ex6Application implements CommandLineRunner {
	...
	@Autowired
	StudentPagingImpl studentPagingImpl;
...
//		System.out.println("Students has ielts score is 8.5" + studentServiceImpl.getStudentsIeltsScoreEqual(8.5));
		...
		System.out.println("List students sorted by age and score: " + studentPagingImpl.getStudentsSortedByAgeScore());
		System.out.println("\nStudents 4-5-6:");
		studentPagingImpl.getStudents456();
	}
}
